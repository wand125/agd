...
const STRINGS = {
  en: {
    ...
    "toast.remoteNoJump": "No local terminal attached to {host}. Open one with: ssh {host} -t 'tmux attach'",
  ...
  ja: {
    ...
    "toast.remoteNoJump": "{host} に繋がった手元のターミナルがありません。ssh {host} -t 'tmux attach' で開いてください",
