...
const STRINGS = {
  en: {
    ...
    "cmd.title": "Rename the session (empty to restore)",
    "prompt.rename": "Session name (empty to restore the original)",
    "toast.renamed": "✎ Renamed to “{name}”",
    "toast.renameCleared": "✎ Restored the original name",
    ...
    "help.life.rename": "Rename the session (the blue title)",
  ...
  ja: {
    ...
    "cmd.title": "表示名を変更(空で元に戻す)",
    "prompt.rename": "セッション名(空にすると元の名前に戻ります)",
    "toast.renamed": "✎ 表示名を「{name}」に変更しました",
    "toast.renameCleared": "✎ 元の表示名に戻しました",
    ...
    "help.life.rename": "表示名(青文字)を変更する",
