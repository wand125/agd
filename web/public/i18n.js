...
const STRINGS = {
  en: {
    ...
    "help.split.dragKey": "drag the divider",
    "help.split.drag": "Resize the columns (double-click a divider to reset)",
  ...
  ja: {
    ...
    "help.split.dragKey": "境目をドラッグ",
    "help.split.drag": "列の幅を変える(ダブルクリックで既定に戻す)",
